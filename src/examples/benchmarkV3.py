...
for case in test_cases:
    ...
    # FIX 1: Allow langdetect to output ID for MY since it lacks an MS profile
    ld_ok = (ld_iso == expected_iso) or (expected_iso == 'ms' and ld_iso == 'id')
    low_ok = (low_iso == expected_iso)
    high_ok = (high_iso == expected_iso)

    if high_ok: lingua_conf_correct.append(top_conf)
    else: lingua_conf_incorrect.append(top_conf)
...
# ==============================================================================
# 5. BENCHMARK 4: CONFIDENCE THRESHOLDING
# ==============================================================================
print("\n" + "=" * 90)
