"""
voting/strategies/run_s2_two_stage.py — formerly voting/scenario2/voting_s2_two_stage.py.
Two-stage voting for Scenario 2.
...
Decision logic lives in voting.strategies.two_stage (see voting/strategies/__init__.py for the
old-name -> new-name mapping). This file is the report-generation harness: it loads models, runs
predictions, and prints the tables/McNemar tests §7 and §9 of the report are sourced from.

Writes: results/logs_scenario2/test_case_7_enmyid/final_report_s2_two_stage.txt
"""
...
from voting.core import (
    ROOT, TARGET_LANGS, LANGUAGE_ORDER, BUCKET_ORDER, EXPECTED_TO_ISO,
...
from voting.strategies.two_stage import (
    MSID, collapse_msid, stage1_s2, s2_agree_lc, s2_3agree, fit_weighted,
    s2_hard_pred, s1_ts_agree,
)
